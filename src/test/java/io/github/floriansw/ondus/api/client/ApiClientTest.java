...
import io.github.floriansw.ondus.api.TestResponse;
...
public class ApiClientTest {
    ...
    public void get_callsHttpClientWithGetAndToken() throws Exception {
        mockHttpClient.httpURLConnection = TestResponse.getOkResponse();
        ApiClient client = new ApiClient(TEST_BASE_URL, mockHttpClient);
        client.setToken(TestResponse.A_TOKEN);
        ...
        Assert.assertEquals("Bearer " + TestResponse.A_TOKEN, captor.getValue());
    }
